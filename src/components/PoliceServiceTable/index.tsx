...
import dayjs from "dayjs"; // Assurez-vous que le chemin est correct
...
const columns: Column[] = [
    ...
    {
        id: 'dernierPDS',
        label: 'Début du shift',
        minWidth: 70,
        align: 'center',
        format: (value: any) => dayjs(value).format('DD-MM-YYYY | HH:mm')
    },
    {
        id: 'discordId',
        label: 'Discord',
        minWidth: 70,
        align: 'center',
        format: (value: any) => <button className="btn watch-profil"><i className="bi bi-eye-fill"></i></button>
...
const PoliceServiceTable: React.FC<{
    data: AgentData[],
...
export default PoliceServiceTable;
